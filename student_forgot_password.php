...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($email)) {
        ...
        if ($student->updatePassword($email, $hashed_password)) {
            // Send email with new password
            $to = $email;
            $subject = "Your New Password - Student Account";
...
<head>
    ...
    <title>Student Forgot Password - Zarqa University</title>
...
<body>
    <div class="forgot-container">
        <form class="forgot-form" method="POST" action="">
            <h2><i class="fas fa-user-graduate"></i> Student Password Reset</h2>
            ...
            <div style="text-align: center; margin-top: 1rem;">
                <a href="student_login.php" style="color: var(--secondary-color); text-decoration: none; display: inline-block; margin-top: 0.5rem;">
